    ...
    case WM_COMMAND:
        {
            ...
            case IDM_ABOUT:
                ...
                break;
            case ID_TESTMESSAGEA:
                MessageBoxA(0,"测试MessageBoxA","Test",0);
                break;
            case ID_TESTMESSAGEW:
                MessageBoxW(0, L"测试MessageBoxW", L"Test", 0);
                break;
            case ID_TESTCREATEFILE:
                CreateFile("G:\\User\\Desktop\\Create.txt", GENERIC_READ, FILE_SHARE_READ, NULL, CREATE_NEW, NULL, NULL);
                break;
            case ID_COPYFILE:
                CopyFileW(L"G:\\User\\Desktop\\Copy1.txt",L"G:\\User\\Desktop\\Copy2.txt",0);
                break;
            case IDM_EXIT:
                DestroyWindow(hWnd);
                break;
